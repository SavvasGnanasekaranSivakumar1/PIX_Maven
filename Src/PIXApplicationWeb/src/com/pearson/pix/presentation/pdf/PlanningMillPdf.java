...
public class PlanningMillPdf implements CommonPdfInterface{
...
private Table Header(Font objFont,PurchaseOrderDetailForm poDetailForm,float width,float[] columnDefinitionSize) throws AppException
{
		...
		Table objTable = null;
		 try
		 {
		    ...
		    ncell = new Cell(new Phrase("MATERIALID:",objFont));
		    ...
		    ncell.setBackgroundColor(new Color(236, 245, 253));
		    objTable.addCell(ncell);
		    if (poDetailForm.getPoHeader() != null && poDetailForm.getPoHeader().getTitleDetail() != null && poDetailForm.getPoHeader().getTitleDetail().getPaperGrade() != null){
		    ...
		    ncell.setBackgroundColor(new Color(236, 245, 253));
		    objTable.addCell(ncell);
		    if(poDetailForm.getPoHeader() != null && poDetailForm.getPoHeader().getUOMDetail().getUom() != null)
		    {
		    	if(poDetailForm.getPoHeader().getUOMDetail().getUom().equalsIgnoreCase("LB"))
		    	{
		    ...
		    ncell = new Cell(new Phrase("Quantity:",objFont));
		    ncell.setBackgroundColor(new Color(236, 245, 253));
		    objTable.addCell(ncell);
		    if(poDetailForm.getPoHeader() != null && poDetailForm.getPoHeader().getTotalQuantity() != null)
		    {
...
/*private String delBlanks(String string)
{
   String result="";
   int i=0;
   char chrn;
   for (i=0;i<string.length();++i) {
      chrn=string.charAt(i);
      if (chrn!='\n')
      {
    	  chrn=' ';
    	  result += chrn;
