// Decompiled by DJ v3.9.9.91 Copyright 2005 Atanas Neshkov  Date: 8/14/2007 12:44:44 PM
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   AjaxGroup.java
...
public class AjaxGroup
{
    ...
    private boolean validate()
    {
        ...
        if(!method.equalsIgnoreCase("head") && !method.equalsIgnoreCase("get") && !method.equalsIgnoreCase("post") && !method.equalsIgnoreCase("put") && !method.equalsIgnoreCase("delete") && !method.equalsIgnoreCase("trace") && !method.equalsIgnoreCase("options") && !method.equalsIgnoreCase("connect"))
        {
            valid = false;
        }
        return valid;
   ...
   /* static Class _mthclass$(String x0)
    ...
    static 
    {
        ...
        {
            System.err.println("AjaxGroup could not be loaded by classloader because classes it depends on could not be found in the classpath...");
            e.printStackTrace();
        }
        log = LogFactory.getLog(com.pearson.pix.presentation.ajax.progressbar.config.AjaxGroup.class);
    }
}