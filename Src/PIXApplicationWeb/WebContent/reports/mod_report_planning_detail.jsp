...
<tr>
    <td align="left" valign="top" class="padding23">
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="20" align="left" valign="top" class="headingMain"><span class="headingMainArrow">&gt; </span>${orderDetailForm.poHeader.titleDesc}</td>
        </tr>
        <tr>
            ...
            <tr>
              <td width="30%" valign="top"><fieldset class="legendBorder">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="textLegend">${buyer.orgUnitName}<br>
...
<c:if test="${contactBuyer.email!=null}">&nbsp;${contactBuyer.email} </c:if><br>
              ...
              <td width="30%" valign="top"><fieldset class="legendBorder">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="textLegend">${vendor.orgUnitName}<br>
...
<c:if test="${contactVendor.email!=null}">&nbsp;${contactVendor.email} </c:if><br>
              ...
              <td width="30%" valign="top"><fieldset class="legendBorder">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td class="textLegend">${shipTo.orgUnitName}<br>
