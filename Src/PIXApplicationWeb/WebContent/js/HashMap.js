...
HashMap.prototype.hash = function(key){
    //alert('Math.abs(key.hashCode() % this.buckets.length)......'+key+'.....'+Math.abs(key.hashCode() % this.buckets.length))
     // alert('this.buckets.length..'+this.buckets.length)
