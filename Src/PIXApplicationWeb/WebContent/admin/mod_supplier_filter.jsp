...
<%@ page errorPage="/common/mod_error.jsp" isErrorPage="false" %>
  ...
  <html-el:form action="/admin/listsup?PAGE_VALUE=1&ADMIN_MODULE=SUP">
  <%@ include file="/common/formbegin.jsp"%>
  <tr>
    <td height="25" align="left" valign="top"><img src="<%=request.getContextPath()%>/images/heading_icon.gif" width="23" height="9"><span class="headingText">Manage Supplier - Filter </span></td>
  </tr>
  ...
  <tr>
    <td align="left" valign="top" class="padding23">
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td class="text">You can filter suppliers based on the following attributes. </td>
        </tr>
        <tr>
      ...
      <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td id="buttons2" class="tabSelectTextleft">
			<html-el:submit value="Filter" styleClass="buttonMain" onclick="javascript: return dateCheck(document.supplierForm.endDate.value,document.supplierForm.startDate.value,'>=','Start Date should be ','End Date');"/>
			</td>
            </tr>
            </table>
          </label></td>
