...
<c:forEach var="party" items="${bookspecform.bookSpec.partyCollection}" varStatus="partyCount">
 ...
 <tr>
    ...
    <span class="headingText">Book Specification No.  <c:out value="${bookspecform.bookSpec.specNo}"/> - <c:out value="${bookspecform.bookSpec.releaseNo}"/> </span></td>
  </tr>
  <tr>
    ...
    <c:if test="${lineItem.nonPressDetail!=null}">
           ...
           <table width="98%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top"><table width="98%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <textarea class="textsmall" readonly="readonly" rows="5" style="color: black; background-color:transparent; border:none; overflow:visible; width:722px;text-align:left">${buyer.comments}
 					  </textarea>
                      </td>
                    </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                <td><input name="Button32" type="button" class="buttonMain" onClick="javascript:window.close();" value="Close"></td></tr>
              <tr>
                <td height="15"></td>
              </tr>
                  </table>
