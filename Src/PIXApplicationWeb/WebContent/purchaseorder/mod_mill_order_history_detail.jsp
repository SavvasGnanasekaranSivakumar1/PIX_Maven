...
<c:set var="ordernew" value='<%=request.getParameter("ordernew")%>'/>
          ...
          <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
            <tr>
              ...
              <td class="lightblueColumn">
              	<html-el:hidden property="poHeader.totalQuantity" value="${orderDetailFormHist.poHeader.totalQuantity}"/>
			  	${orderDetailFormHist.poHeader.totalQuantity}
              </td>
              
            </tr>
            <tr>
              <td height="23" class="blueColumn">PAPER GRADE: </td>
              <td class="lightblueColumn">${orderDetailFormHist.poHeader.titleDetail.paperGrade}</td>	
            ...
            <tr>
              ...
              <td class="lightblueColumn"> ${orderDetailFormHist.poHeader.titleDetail.basisWeight}</td>
              <td class="blueColumn">UOM: </td>
              <td class="lightblueColumn" id="headerDlDate">
              	<c:choose>
              		<c:when test="${orderDetailFormHist.poHeader.UOMDetail.uom=='LB'}">
              			<c:out value="Roll"/>
              		</c:when>
              		<c:when test="${orderDetailFormHist.poHeader.UOMDetail.uom=='SH'}">
              			<c:out value="Sheet"/>
              		</c:when>
...
<c:if test="${contactBuyer.email!=null}">&nbsp;${contactBuyer.email} </c:if><br>
              ...
              <td width="30%" valign="top"><fieldset class="legendBorder">
                <legend class="legendeTitle">MILL (${vendor.san})</legend>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="5"></td>
                  </tr>
	                ...
	                <tr>
	                  <td height="20" colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      ...
	                      <td align="right" class="totalPrice"> <fmt:formatNumber value="${orderDetailFormHist.poHeader.totalAmount}" minFractionDigits="2" maxFractionDigits="2" pattern="#,###.##"/></td>
	                    </tr>
	                  </table></td>
	                  </tr>
	              </table>
