      ...
      <tr>
       ...
       <table width="98%" border="0" cellspacing="1" cellpadding="0">
        ...
        <tr>
          ...
          <td class="${class1}">
          <html-el:link styleClass="${class2}" page="/purchaseorder/orderdetailhistory.do?poid=${poHeader.poId}&poversion=${poHeader.poVersion}&pono=${poHeader.poNo}&rno=${poHeader.releaseNo}&page=H"><c:out value="${poHeader.poNo}"/></html-el:link>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <c:if test="${prevValue!=null && prevValue!=''}">
           ...
           <a class="backNext" href="javascript:listfilter('${PATH}/purchaseorder/purchaseorderhistorylist.do?PAGE_VALUE=${prevValue}&party=<%=partyType%>&page=H&ponumber=${headeroutofloop.poNo}&poid=${headeroutofloop.poId}')">
           <img src="<%=request.getContextPath()%>/images/prev.gif" alt="previous" border="0"></a> 
          </c:if>
          <c:if test="${nextValue!=null && nextValue!=''}">
          <a class="backNext" href="javascript:listfilter('${PATH}/purchaseorder/purchaseorderhistorylist.do?PAGE_VALUE=${nextValue}&party=<%=partyType%>&page=H&ponumber=${headeroutofloop.poNo}&poid=${headeroutofloop.poId}')">
...
<%--
 <c:if test="${errorMsg != null}">
       ...
       <tr>
        <td colspan="2" class="text" style="color:red;"> 
        			 (*) - Buyer finalized the PO and costs are available. <br>

 					 (#) - Paper Assigned for this title.
        </td>
       </tr>
      </table> --%>
      </html-el:form>
