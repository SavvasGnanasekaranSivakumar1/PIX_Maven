			...
			<td align="left" valign="top" class="padding23">
				...
				<table width="98%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						...
						<td class="inboxdrakBlue2">
						  <html-el:text property="poHeader.gangName" styleClass="textfield" />                  
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">
							<label>
							    ...
							    <input name="Button2" type="button" class="buttonMain" onClick="javascript: return sfilter('${contextPath}/purchaseorder/purchaseorderlist.do')" value="Filter">  
