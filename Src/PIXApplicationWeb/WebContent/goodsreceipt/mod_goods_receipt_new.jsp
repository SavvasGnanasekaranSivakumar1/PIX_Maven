    ...
    <td align="left" valign="top" class="padding23">
      ...
      <table width="98%" border="0" cellspacing="1" cellpadding="0">
       ...
       <tr>
        ...
        <tr>
          <td class="${class1}"><c:out value="${goodsreceiptLine.lineNo}"/></td>
          <td valign="top" class="${class1}">
          <c:out value="${goodsreceiptLine.productDescription}"/></td>
          <td class="${class1}"><c:out value="${goodsreceiptLine.balanceQuantity}"/></td>
          <td valign="top" class="${class1}">
...
%>  
          ...
          <input name="Button1" type="button" class="buttonMain" onClick="if(validate(${totalLineItems})){submitAction('<%=request.getContextPath()%>/goodsreceipt/insertnewgoodsreceipt.do?poid=${poid}&poversion=${poversion}&pono=${pono}&rno=${rno}&order=${order}&page_order_list=${page_order_list}',this)}else{return false;}" value="Submit">  
