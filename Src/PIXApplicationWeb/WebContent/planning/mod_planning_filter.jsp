		...
		<tr>
			<td align="left" valign="top" class="padding23">
				...
				<table width="98%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
					<td width="17%" rowspan="2" class="titleBlue2">BOOK BOUND DATE - </td>
						<td class="titleBlue2">START DATE:</td>
						<td class="inboxdrakBlue2">
						<html-el:text size="12" property="sbBDate" styleClass="textfield" styleId="demo3" />
					...
					<td class="titleBlue2">END DATE:</td>
						<td class="inboxdrakBlue2">
						<html-el:text size="12" property="ebBDate" styleClass="textfield" styleId="demo4" />
				...
				<tr>
                   <td width="17%" rowspan="2" class="titleBlue2">PLAN POSTED  DATE - </td>
              	    <td class="titleBlue2">START DATE:</td>
						<td class="inboxdrakBlue2">
						<html-el:text size="12" property="startDate" styleClass="textfield" readonly="true" styleId="demo1" />
					...
					<td class="titleBlue2">END DATE:</td>
						<td class="inboxdrakBlue2">
						<html-el:text size="12" property="endDate" styleClass="textfield" readonly="true" styleId="demo2" />
					...
					<tr>
						<td colspan="2">
							...
							<!-- 	<html-el:submit property="submit" value="Filter" styleClass="buttonMain"  onclick="javascript: return sfilter('${contextPath}/planning/planninglist.do?PAGE_VALUE=1');filtercheck();"/>  -->
								<input name="Button3" type="button" class="buttonMain" onClick="javascript: return sfilter('${contextPath}/planning/planninglist.do?PAGE_VALUE=1');filtercheck();" value="Filter">
