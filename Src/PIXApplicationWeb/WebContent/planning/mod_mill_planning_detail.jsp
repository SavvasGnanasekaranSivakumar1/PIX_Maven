...
<html-el:form action="/planning/millplanningdetail">
...
<c:forEach var="lineItem" items="${orderDetailForm.poHeader.lineItemCollection}" varStatus="lineInfo">
  ...
  <tr>
    <td align="left" valign="top" class="padding23">
     ...
     <tr>
        <td colspan="2" class="text"> Following are the details of the Planning. </td>
        </tr>
        <tr>
        ...
        <tr>
          <td><table width="100%"  border="0" cellspacing="1" cellpadding="0">
            <tr>
              ...
              <td width="16%" class="blueColumn">STATUS: 
              </td>
              <td class="lightblueColumn"><c:forEach var="itemBuyer" items="${planningAllStatus}">
            ...
            <td class="blueColumn">UOM: </td>
             ...
             <td class="blueColumn">Quantity: </td>
              <td class="lightblueColumn" id="headerDlDate">
              <fmt:formatNumber value="${orderDetailForm.poHeader.totalQuantity}" pattern="###,###"/>
              </td>
...
<c:if test="${contactBuyer.email!=null}">&nbsp;${contactBuyer.email} </c:if><br>
              ...
              <td width="30%" valign="top"><fieldset class="legendBorder">
                <legend class="legendeTitle">MILL/MERCHANT (${vendor.san})
...
${orderDetailForm.poHeader.termsConditions}
        ...
        <tr>
         ...
         <input type="hidden" name="ebBDateFilter" value="${ebBDateFilter}"/>
          ...
          <c:if test="${readOnlyForm!='T'}">
          	...
          	<input type="hidden" name="roleType" value="M"/>
    ...
    <html-el:form action="/planning/millplanninglist.do">
    </html-el:form>
      </table></td>
  </tr>